...
class seventeen extends Component{
    ...
    slidingComplete(itemSelected) {
        ...
        data[16] = this.sliderOptions[this.refs.slider.state.item].value ;
        data.push() ;
        console.log(data);
    }
        ...
        return <View style={styles.container}>
            ...
            <View style={{top: 50, flex:1}}>
                <Text style={styles.choice}>
                    { this.sliderOptions[currentItem].value === 1 ? 'fullt av förändringar utan att\ndu vet vad som händer härnäst' : ' ' &&
                    this.sliderOptions[currentItem].value === 6 ? 'helt förutsägbar och utan\n överraskande förändringa' : ' ' }
                </Text>
            </View>
