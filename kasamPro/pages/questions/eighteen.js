    ...
    render() {
        ...
        return <View style={styles.container}>
            <View>
                <View style={styles.rectangle}>
                    <Text style={styles.welcome}>
                        18. När något otrevligt
                        hände tidigare brukade du ....
                    </Text>
                </View>
            </View>
            ...
            <Text style={styles.choice}>
                { this.sliderOptions[currentItem].value === 1 ? 'älta det om och om igen' : ' ' &&
                this.sliderOptions[currentItem].value === 6 ?  'säga det var det och sedan gå vidare' : ' ' }
            </Text>
