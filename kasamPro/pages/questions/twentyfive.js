...
class twentyfive extends Component{
    ...
    slidingComplete(itemSelected) {
        ...
        data[24] = this.sliderOptions[this.refs.slider.state.item].value ;
        data.push() ;
        console.log(data);
    }
        ...
        return <View style={styles.container}>
            <View style={{height:180, flex:1}}>
                <Text style={styles.question}>
                    25. Även en människa med stark självkänsla kan ibland känna sig som en olycksfågel. Hur ofta har du kännt det så ?
                </Text>
            </View>
            ...
            <View style={{top: 50, flex:1}}>
                <Text style={styles.choice}>
                    { this.sliderOptions[currentItem].value === 1 ? 'aldrig' : ' ' &&
            ...
            <View style={{flex:1,bottom:25}}>
                <View style={{top: 30,flex:1}}>
                    <TouchableOpacity
                        onPress={() =>
                            this.props.navigation.navigate('twentysix')}
