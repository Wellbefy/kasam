...
class twentysix extends Component{
    ...
    slidingComplete(itemSelected) {
        ...
        data[25] = this.sliderOptions[this.refs.slider.state.item].value ;
        data.push() ;
        console.log(data);
    }
        ...
        return <View style={styles.container}>
            ...
            <View style={{top: 50, flex:1}}>
                <Text style={styles.choice}>
                    { this.sliderOptions[currentItem].value === 1 ? 'du över eller undervärderade \n dess betydelse ' : ' ' &&
                    this.sliderOptions[currentItem].value === 6 ? 'du såg saken i dess\n rätta proportion' : ' ' }
                </Text>
            </View>
