        ...
        return <View style={styles.container}>
            <View>
                <View style={styles.rectangle}>
                    <Text style={styles.welcome}>
                        26. När något har hänt, har du vanligtvis funnit at ....
                    </Text>
                </View>
            </View>
            ...
            <View>
                <TouchableOpacity
                    style={styles.touch1}
                    onPress={() =>
                        this.props.navigation.navigate('twentyseven')}>
                    <Image
                ...
                <TouchableOpacity
                    style={styles.touch2}
                    onPress={() =>
                        this.props.navigation.navigate('twentyfive')}>
                    <Image
                        style={{width: 150, height: 50}}
            ...
            <Text style={styles.choice}>
                { this.sliderOptions[currentItem].value === 1 ? 'du över eller undervärderade dess betydelse  ' : ' ' &&
                this.sliderOptions[currentItem].value === 6 ? 'du såg saken i dess rätta proportion ' : ' ' }
            </Text>
