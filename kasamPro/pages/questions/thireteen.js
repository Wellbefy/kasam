...
class thireteen extends Component{
    sliderOptions = [
        {value: 6, label: '1'},
        {value: 5, label: '2'},
        {value: 4, label: '3'},
    ...
    slidingComplete(itemSelected) {
        ...
        data[12] = this.sliderOptions[this.refs.slider.state.item].value ;
        data.push() ;
        console.log(data);
    }
        ...
        return <View style={styles.container}>
            ...
            <View style={{top: 50, flex:1}}>
                <Text style={styles.choice}>
                    { this.sliderOptions[currentItem].value === 1 ? 'det går alltid att finna\nlösning på livets svårigheter' : ' ' &&
                    this.sliderOptions[currentItem].value === 6 ? 'det finns ingen lösning \npå livets svårigheter' : ' ' }
                </Text>
            </View>
