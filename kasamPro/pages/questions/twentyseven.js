...
class twentyseven extends Component{
    ...
    slidingComplete(itemSelected) {
        ...
        data[26] = this.sliderOptions[this.refs.slider.state.item].value ;
        data.push() ;
        console.log(data);
    }
        ...
        return <View style={styles.container}>
            ...
            <View style={{top: 50, flex:1}}>
                <Text style={styles.choice}>
                    { this.sliderOptions[currentItem].value === 1 ? 'du alltid kommer att \n lyckas svårigheterna' : ' ' &&
                    this.sliderOptions[currentItem].value === 6 ? 'du inte kommer att lyckas \n övervinna svårigheterna' : ' ' }
                </Text>
            </View>
