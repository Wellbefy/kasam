        ...
        return <View style={styles.container}>
            ...
            <View>
                <TouchableOpacity
                    style={styles.touch1}
                    onPress={() =>
                        this.props.navigation.navigate('twentyeight')}>
                    <Image
            ...
            <Text style={styles.choice}>
                { this.sliderOptions[currentItem].value === 1 ? 'du alltid kommer att lyckas svårigheterna' : ' ' &&
                this.sliderOptions[currentItem].value === 6 ? ' du inte kommer att lyckas övervinna svårigheterna' : ' ' }
            </Text>
