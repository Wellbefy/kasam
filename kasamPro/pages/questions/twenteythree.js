...
class twentythree extends Component{
    ...
    slidingComplete(itemSelected) {
        ...
        data[22] = this.sliderOptions[this.refs.slider.state.item].value ;
        data.push() ;
        console.log(data);
    }
        ...
        return <View style={styles.container}>
            ...
            <View style={{top: 50, flex:1}}>
                <Text style={styles.choice}>
                    { this.sliderOptions[currentItem].value === 1 ? 'det är du helt säker på' : ' ' &&
                    this.sliderOptions[currentItem].value === 6 ? 'det tvivlar du på' : ' ' }
                </Text>
            </View>
            ...
            <View style={{flex:1,bottom:25}}>
                <View style={{top: 30,flex:1}}>
                    <TouchableOpacity
                        onPress={() =>
                            this.props.navigation.navigate('twentyfour')}
