    ...
    render() {
        ...
        return <View style={styles.container}>
            <View>
                <View style={styles.rectangle}>
                    <Text style={styles.welcome}>
                        13. Vilket påstående beskriver bäst
                        hur du ser på livet ?
                    </Text>
                </View>
            </View>
            ...
            <Text style={styles.choice}>
                { this.sliderOptions[currentItem].value === 1 ? 'det går alltid att finna en lösning på livets svårigheter' : ' ' &&
                this.sliderOptions[currentItem].value === 6 ? 'det finns ingen lösning på livets svårigheter' : ' ' }
            </Text>
