    ...
    render() {
        ...
        return <View style={styles.container}>
            ...
            <Text style={styles.choice}>
                { this.sliderOptions[currentItem].value === 1 ? 'fullt av förändringar utan att du vetat vad som skulle hända härnäst' : ' ' &&
                this.sliderOptions[currentItem].value === 6 ? 'helt förutsägbart utan överaskande förändringar' : ' ' }
            </Text>
